 ...
 * <h1>Keys Class</h1>
 * <p>
 * This class contains the key codes of all keys on an English US Keyboard as 
 * well as some from the Japanese Keyboard. The purpose of this class is to 
 * provide a layer of separation between this engine and OpenGL so the engine 
 * does not rely on continued and updated support from OpenGL.
 * 
 * @author Graham
 * @version 2.0.0
 * @since 2019-05-16
